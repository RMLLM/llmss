...
OpenLlamaRMSNorm.load_no_bias = load_layer_norm_no_bias
...
class OpenLlamaMLP(nn.Module):
    def __init__(self, prefix, config: OpenLlamaConfig, weigths):
        super().__init__()
...
class OpenLlamaAttention(nn.Module):
    ...
    def __init__(self, prefix, config: OpenLlamaConfig, weights):
        super().__init__()
        # default configs for open llama
        self.config = config
        ...
        # configs for multi query attention
        ...
        self._init_rope(prefix, weights)
...
class OpenLlamaDecoderLayer(nn.Module):
    def __init__(self, prefix, config: OpenLlamaConfig, weights):
        ...
        self.post_attention_layernorm = OpenLlamaRMSNorm.load_no_bias(
